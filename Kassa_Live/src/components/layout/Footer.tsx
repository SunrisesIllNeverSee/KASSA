      ...
      <div className="max-w-[1300px] mx-auto px-6 sm:px-12 py-12 flex flex-col sm:flex-row justify-between gap-10">
        ...
        <div className="flex gap-16">
          <div className="flex flex-col gap-3">
            ...
            <Link href="/" className="text-sm text-driftwood hover:text-bone transition-colors">Browse Listings</Link>
            <Link href="/" className="text-sm text-driftwood hover:text-bone transition-colors">How It Works</Link>
          </div>
          <div className="flex flex-col gap-3">
            <span className="font-mono text-[10px] text-gold uppercase tracking-widest font-bold mb-1">Founders</span>
            <Link href="/list" className="text-sm text-driftwood hover:text-bone transition-colors">List Your Product</Link>
          </div>
        </div>
      </div>
    </footer>
